...
//       <ol className="list-decimal list-inside space-y-2 text-slate-300">
//         <li>Enter <span className="text-white">Length</span> and <span className="text-white">Width</span> of the slab.</li>
//         <li>Enter <span className="text-white">Thickness</span> (commonly 4 in / 100 mm for light-duty slabs).</li>
//         <li>(Optional) Add a <span className="text-white">Waste/Overage %</span> to cover spillage and uneven sub-base.</li>
//         <li>View instant results in <span className="text-white">cubic yards (yd³)</span> and <span className="text-white">cubic meters (m³)</span>.</li>
//         <li>Round up when ordering ready-mix; suppliers typically deliver in 0.5 or 1.0 yd³ increments.</li>
//       </ol>
...
// /* ---------- Reusable UI bits (keeps the file self-contained) ---------- */
