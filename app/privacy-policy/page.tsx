...
import { ShieldCheck, Lock, Cookie, Clock, Mail, FileText, MessageCircleQuestion } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xs text-slate-500 mt-2">
              Summary refreshed to reflect the July 2024 analytics and cookie review.
            </p>
          </div>
          ...
          <article className="prose prose-invert prose-slate max-w-none">
            <div className="bg-slate-800 border border-slate-700 rounded-lg p-8">
              ...
              <p className="text-slate-300 mb-4">
                <strong>Usage data:</strong> anonymous or aggregated information such as pages visited, calculator features used,
                and basic device information.
                <br />
                <strong>Optional contact data:</strong> if you contact us (e.g., support email), we receive your message and any
                provided contact details.
              </p>

              <h3 className="text-2xl font-semibold text-white mb-4 mt-6">2) How We Use Information</h3>
              <p className="text-slate-300 mb-4">
                To operate the website, improve calculator accuracy and usability, monitor performance, prevent abuse, and respond
                to your inquiries.
              </p>

              <h3 className="text-2xl font-semibold text-white mb-4 mt-6">3) Cookies & Similar Technologies</h3>
              <p className="text-slate-300 mb-4">
                We may use essential cookies for site functionality and lightweight analytics cookies to understand aggregate
              ...
              <p className="text-slate-300 mb-4">
                We may link to external sites or use third-party tools (e.g., analytics or advertising). Their practices are
                governed by their own policies. Review those policies before using their services.
              </p>

              <h3 className="text-2xl font-semibold text-white mb-4 mt-6">5) Data Retention</h3>
              <p className="text-slate-300 mb-4">
                We keep data only as long as needed to provide and improve the service or comply with legal obligations, then
              ...
              <p className="text-slate-300 mb-4">
                Our calculators are intended for general audiences and are not directed to children under 13. We do not knowingly
                collect data from children.
              </p>

              <h3 className="text-2xl font-semibold text-white mb-4 mt-6">8) Your Choices & Rights</h3>
              <p className="text-slate-300 mb-4">
                You can disable non-essential cookies in your browser. If you contact us about your information, we will
                reasonably assist with access, correction, or deletion requests where applicable.
              </p>

              <h3 className="text-2xl font-semibold text-white mb-4 mt-6">9) Changes to This Policy</h3>
              <p className="text-slate-300 mb-4">
                We may update this policy to reflect improvements or legal requirements. Material changes will be noted by
