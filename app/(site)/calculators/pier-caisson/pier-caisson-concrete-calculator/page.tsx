...
export const metadata: Metadata = {
  ...
  "alternates": {
    "canonical":
      "https://www.concretecalculatormax.com/calculators/pier-caisson-concrete-calculator"
  },
  "openGraph": {
    "type": "article",
    "url": "https://www.concretecalculatormax.com/calculators/pier-caisson-concrete-calculator",
    "title": "Pier / Caisson Concrete Calculator",
    "description":
    ...
    "@graph": [
      {
        "@type": "WebApplication",
        "@id":
          "https://www.concretecalculatormax.com/calculators/pier-caisson-concrete-calculator#app",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "item": "https://www.concretecalculatormax.com/calculators/pier-caisson"
          },
          {
            "@type": "ListItem",
            "position": 3,
      ...
      <main className="container-xl">
        ...
        <nav aria-label="Breadcrumb" className="mb-3 text-sm text-slate-400">
          <ol className="flex gap-2">
            ...
            <li className="px-1 text-slate-500">/</li>
            <li>
              <Link href="/calculators/pier-caisson" className="hover:underline">
                Pier & Caisson
              </Link>
            </li>
            <li className="px-1 text-slate-500">/</li>
