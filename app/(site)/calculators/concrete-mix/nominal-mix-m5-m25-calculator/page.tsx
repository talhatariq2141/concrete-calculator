...
export const metadata: Metadata = {
  ...
  "alternates": {
    "canonical":
      "https://www.concretecalculatormax.com/calculators/nominal-mix-m5-m25-calculator"
  },
  "openGraph": {
    "type": "article",
    "url": "https://www.concretecalculatormax.com/calculators/nominal-mix-m5-m25-calculator",
    "title": "Nominal Mix (M5–M25) Concrete Calculator",
    "description":
    ...
    "@graph": [
      {
        "@type": "WebApplication",
        "@id":
          "https://www.concretecalculatormax.com/calculators/nominal-mix-m5-m25-calculator#app",
        ...
        "publisher": {
          ...
          "logo": {
            "@type": "ImageObject",
            "url": "https://www.concretecalculatormax.com/og/logo.png" // ensure file exists
          }
        },
        "potentialAction": {
          "@type": "Action",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            "@type": "ListItem",
            "position": 4,
            "name": "Concrete Mix Calculators",
            "item": "https://www.concretecalculatormax.com/calculators/concrete-mix"
          },
          {
            "@type": "ListItem",
            "position": 3,
      ...
      <main className="container-xl">
        ...
        <nav aria-label="Breadcrumb" className="mb-3 text-sm text-slate-400">
          <ol className="flex gap-2">
            ...
            <li className="px-1 text-slate-500">/</li>
            <li>
              <Link href="/calculators/concrete-mix" className="hover:underline">
                Concrete Mix
              </Link>
            </li>
            <li className="px-1 text-slate-500">/</li>
