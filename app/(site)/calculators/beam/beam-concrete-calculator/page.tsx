...
export const metadata: Metadata = {
  ...
  "alternates": {
    "canonical":
      "https://www.concretecalculatormax.com/calculators/beam-concrete-calculator"
  },
  "openGraph": {
    "type": "article",
    "url": "https://www.concretecalculatormax.com/calculators/beam-concrete-calculator",
    "title": "Beam Concrete Calculator",
    "description":
    ...
    "@graph": [
      {
        "@type": "WebApplication",
        "@id":
          "https://www.concretecalculatormax.com/calculators/beam-concrete-calculator#app",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            "@type": "ListItem",
            "position": 4,
            "name": "Beam Calculators",
            "item": "https://www.concretecalculatormax.com/calculators/beam"
          },
          {
            "@type": "ListItem",
            "position": 3,
      ...
      <main className="container-xl">
        ...
        <nav aria-label="Breadcrumb" className="mb-3 text-sm text-slate-400">
          <ol className="flex items-center flex-wrap gap-1">
            ...
            <li className="px-1 text-slate-500">/</li>
            <li>
              <Link href="/calculators/beam" className="hover:underline">
                Beam
              </Link>
            </li>
            <li className="px-1 text-slate-500">/</li>
