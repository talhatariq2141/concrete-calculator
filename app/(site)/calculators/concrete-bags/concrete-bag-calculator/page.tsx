...
export const metadata: Metadata = {
  ...
  "alternates": {
    "canonical":
      "https://www.concretecalculatormax.com/calculators/concrete-bag-calculator"
  },
  "openGraph": {
    "type": "article",
    "url": "https://www.concretecalculatormax.com/calculators/concrete-bag-calculator",
    "title": "Concrete Bag Calculator",
    "description":
    ...
    "@graph": [
      {
        "@type": "WebApplication",
        "@id":
          "https://www.concretecalculatormax.com/calculators/concrete-bag-calculator#app",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            "@type": "ListItem",
            "position": 4,
            "name": "Concrete Bags Calculators",
            "item": "https://www.concretecalculatormax.com/calculators/concrete-bags"
          },
          {
            "@type": "ListItem",
            "position": 3,
      ...
      <main className="container-xl">
        ...
        <nav aria-label="Breadcrumb" className="mb-3 text-sm text-slate-400">
          <ol className="flex items-center flex-wrap gap-1">
            ...
            <li className="px-1 text-slate-500">/</li>
            <li>
              <Link href="/calculators/concrete-bags" className="hover:underline">
                Concrete Bags
              </Link>
            </li>
            <li className="px-1 text-slate-500">/</li>
