  ...
  "@graph": [
    {
      "@type": "WebApplication",
      "@id":
        "https://concretecalculatormax.com/calculators/staircase-concrete-calculator#app",
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Staircase Concrete Calculator", "item": "https://concretecalculatormax.com/calculators/staircase-concrete-calculator" }
      ]
    },
    {
      "@type": "HowTo",
